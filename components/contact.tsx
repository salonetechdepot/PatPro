...
export function Contact() {
  return (
    <section id="contact" className="py-16 md:py-24 lg:py-32 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty leading-relaxed">
            Ready to experience the Pat Pro Cleaning difference? Contact us today for a free quote.
          </p>
        </div>
            ...
            <Card className="border-border">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@patprocleaning.com</p>
                </div>
              </CardContent>
            </Card>
